...
def get_distance(destination):
    ...
    try:
        ...
        if data.get('status') != 'OK':
            return None, f"API status: {data.get('status')} — {data.get('error_message','')}"

        element = data['rows'][0]['elements'][0]
        if element.get('status') != 'OK':
            return None, f"Route status: {element.get('status')}"
...
def estimate_by_zip(address):
    ...
    far = {'98201','98203','98204','98205','98207','98208','98270','98271','98272','98273','98274','98275','98276','98277','98278','98279','98280','98281','98282','98283','98284','98290','98291','98292','98293','98294','98295','98296','98297','98597','98598','98579','98531','98532','98533','98560','98576'}
    if zip_code in close: return 20
    elif zip_code in medium: return 45
    elif zip_code in far: return 65
    else: return 35
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if error or not miles:
            # Fallback to ZIP estimate
            est_miles = estimate_by_zip(address)
            total_miles = est_miles * 4
            mileage_cost = round(total_miles * 0.27, 2)
            gallons = round(total_miles / 9, 1)
            fuel_cost = round(gallons * 6.00, 2)
            self._respond(200, {
                'miles_one_way': est_miles,
